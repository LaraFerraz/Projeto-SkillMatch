...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $dados = [
        ...
        'localizacao' => $_POST['localidade'] ?? $prestador_detalhes['localizacao'],
        'bio' => $_POST['descricao'] ?? $prestador_detalhes['bio'],
        'foto_perfil' => $prestador_detalhes['foto_perfil'], // manter foto atual
        ...
        <div class="row">
                    ...
                    <form action="" method="POST">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="localidade" name="localidade" value="<?php echo htmlspecialchars($prestador_detalhes['localizacao']); ?>">
                            </div>
                            <div class="col-12">
                                <label for="descricao" class="form-label fw-bold">Descrição</label>
                                <textarea class="form-control" id="descricao" name="descricao" rows="4"><?php echo htmlspecialchars($prestador_detalhes['bio']); ?></textarea>
                            </div>
                            <div class="col-12">
            ...
            <div class="col-lg-4">
                <div class="card p-4 mb-4 text-center">
                    <h5 class="fw-bold mb-3">Minha Foto</h5>
                    <img src="<?php echo htmlspecialchars($prestador_detalhes['foto_perfil'] ?? 'https://via.placeholder.com/150'); ?>" alt="Foto do Prestador" class="img-fluid rounded-circle mb-3">
                </div>
            </div>
        </div>
